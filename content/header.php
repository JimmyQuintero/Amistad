    ...
    <div id="contenedor-id">
        <div id="contenedor-logo">
            ...
            if (file_exists("img/logo.png")) {
                echo '<img src="img/logo.png" alt="Amistad"> </div>';
            } else {
                echo '<img src="../img/logo.png" alt="Amistad"> </div>';
            }
            ?>
            <div id="contenedor-login">
                ...
                if (!isset($_SESSION['id'])) {
                    ...
                    if($_SESSION['user_rol'] == 'administrador') {
                        ...
                        echo '<li><a href="../Amistad/view/gestor_noticias.php">Gestor de noticias</a></li>';
                        if (isset($_GET['id_noticia']))
                            $rutaPublicidad = "ads_view.php?id_noticia=" . $_GET['id_noticia'] . "";
                        else
                            $rutaPublicidad = "/Amistad/view/ads_view.php";
                        ...
                        echo "<li><a href='view/add_user.php' >Registrar Personal Autorizado</a></li>";

                        echo '<li><a href="view/cierre_secion.php">Salir de Seción</a></li>';
